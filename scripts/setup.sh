...
cp "$REPO_DIR/scripts/obsidian-bridge.sh"     "$CLAUDE_DIR/scripts/"
...
echo "  2. 连接 Obsidian（可选）：$CLAUDE_DIR/scripts/obsidian-bridge.sh setup"
echo "  3. 重启 claude（或新开会话）"
echo "  4. 对龙虾说：'去学习观察列表里的仓库'"
echo ""
echo "手动触发学习："
...
echo ""
echo "Obsidian 同步："
echo "  $CLAUDE_DIR/scripts/obsidian-bridge.sh import   # Obsidian → 龙虾知识库"
echo "  $CLAUDE_DIR/scripts/obsidian-bridge.sh export   # 龙虾知识库 → Obsidian"
